...
import { getFresnelMat } from '@/components/trash/_GetFresnelMat';
import getStarfield from '@/components/trash/_GetStarField';
...
const ThreeScene = () => {
    ...
    return <div ref={mountRef} className="fixed left-0 top-0 size-full" />;
};
